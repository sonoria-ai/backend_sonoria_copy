...
# data = {
#     "assistant_name": "Beauty & Bliss",
#     "company_name": "Beauty & Bliss Spa",
#     "company_industry": "Wellness & Spa",
#     "company_description": "Wellness institute specializing in facial treatments, massages, and body care.",
#     "allow_modification": "Yes",
#     "modification_deadline": "24 hours",
#     "allow_annulation": "Yes",
#     "annulation_deadline": "24 hours",
#     "cutoff": "Yes",
#     "cutoff_deadline": "24 hours",
#     "call_transfer": "Unsatisfied client",
#     "type_of_reservation": "Google sync"
# }

data = {
    "assistant_name": "Garage Speed",
    "company_name": "Garage Speed Auto",
    "company_industry": "Auto Repair",
    "company_description": "Auto repair shop specializing in hybrid and electric vehicle maintenance and repair.",
    "allow_modification": "Yes",
    "modification_deadline": "48 hours",
    "allow_annulation": "No",
    "cutoff": "Yes",
    "cutoff_deadline": "24 hours",
    "call_transfer": "Quote requests, Request to speak to a manager",
    "type_of_reservation": "Sms"
}
print(generate_prompt(data, "Welcome to Garage Speed Auto! We specialize in hybrid and electric vehicle maintenance. How can I assist you today?"))

# print(generate_prompt(data, "Hello! How can I assist you today?"))
